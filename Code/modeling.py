...
from transformers import GPT2Tokenizer, gpt2spookyTokenizer, gpt2spookyForCausalLM, gpt2spookyConfig
...
model_gpt_neo = LanguageModel_GPT2Spooky(corpus_filepath=CORPUS_FILEPATH, 
								random_state=random_state, 
								...
								pretrained_model_path='./results/model_weights/gpt2spooky_pretrain/',
								log_file=SCRAPPER_LOG)
